                    ...
                    <div class="grid-list-product-wrapper tab-content">
                        <div id="new-product" class="product-grid product-view tab-pane active">
                            <div class="row">
                                ...
                                <c:forEach items="${listProduct.listProduct}" var="items">
                                    <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                        <div class="product-wrapper mb-35">
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="product-content-wrapper">
                                                    <div class="product-title-spreed">
                                                        <h4><a href="pixel/laptop1.html">${items.name}</a></h4>
                                            ...
                                            <div class="product-list-details">
                                                <h2><a href="pixel/laptop1.html">${items.name}</a>
                                                </h2>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">Lenovo IdeaPad Gaming 3
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">Lenovo IdeaPad Gaming 3 15ARH05
                                                82EY00JXVN</a></h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">Acer Nitro 5 AN515 45
                                                        R3SM</a></h4>
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">Acer Nitro 5 AN515 45 R3SM</a></h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">Acer Aspire 7 A715 42G
                                                        R4ST</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">Acer Aspire 7 A715 42G R4ST</a>
                                            </h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">ASUS TUF Gaming F15 FX506LH
                                                        HN002T</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">ASUS TUF Gaming F15 FX506LH
                                                HN002T</a></h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">Lenovo Legion 5 15ARH05
                                                        82B500GTVN</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">Lenovo Legion 5 15ARH05
                                                82B500GTVN</a></h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">Acer Swift 3 Evo SF314 511
                                                        59LV</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">Acer Swift 3 Evo SF314 511 59LV</a>
                                            </h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">Dell Inspiron 14 5406
                                                        70232602</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">Dell Inspiron 14 5406 70232602</a>
                                            </h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">ASUS ExpertBook P2451FA
                                                        EK0262R</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">ASUS ExpertBook P2451FA EK0262R</a>
                                            </h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">LG Gram 2020 14Z90N
                                                        V.AR52A5</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">LG Gram 2020 14Z90N V.AR52A5</a>
                                            </h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">Acer Swift 3S SF314 42
                                                        R5Z6</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">Acer Swift 3S SF314 42 R5Z6</a>
                                            </h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">Asus ZenBook 14 UX425EA
                                                        BM069T</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">Asus ZenBook 14 UX425EA BM069T</a>
                                            </h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
                                ...
                                <div class="product-width col-md-6 col-xl-4 col-lg-6">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            ...
                                            <div class="product-content-wrapper">
                                                <div class="product-title-spreed">
                                                    <h4><a href="details.jsp">HP Envy 13 BA1027TU
                                                        2K0B1PA</a></h4>
                                                    <div class="product-price">
                                        ...
                                        <div class="product-list-details">
                                            <h2><a href="details.jsp">HP Envy 13 BA1027TU 2K0B1PA</a>
                                            </h2>
                                            <div class="quick-view-rating">
                                                <i class="fa fa-star reting-color"></i>
                                                <i class="fa fa-star reting-color"></i>
