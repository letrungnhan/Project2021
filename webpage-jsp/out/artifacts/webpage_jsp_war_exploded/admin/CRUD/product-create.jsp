...
<div id="layoutSidenav_content">
    <main>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category" class="form-control" aria-label="Default select example">
                                    <jsp:useBean id="inventory" class="com.example.webpagejsp.dao.ProductDao"
                                                 scope="request"/>
                            ...
                            <div class="form-group">
                                ...
                                <select name="discount" class="form-control" aria-label="Default select example">
                                    <jsp:useBean id="discount" class="com.example.webpagejsp.dao.ProductDao"
                                                 scope="request"/>
        ...
        <div id="editEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<%=request.getContextPath()%>/createProduct">
                        <div class="modal-header">
