                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">Cửa hàng</a>
                                                <ul>
                                                    ...
                                                    <li><a href="pixel/product-details.html">product details</a></li>
                                                    <li><a href="pixel/checkout.html">checkout</a></li>
                                                    <li><a href="pixel/wishlist.html">wishlist</a></li>
                                                    <li><a href="pixel/cart.html">cart</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">pages</a>
                                                <ul>
                                                    <li><a href="about-us.html">about us</a></li>
                                                    <li><a href="pixel/cart.html">cart page</a></li>
                                                    <li><a href="pixel/checkout.html">checkout</a></li>
                                                    <li><a href="pixel/wishlist.html">wishlist</a></li>
                        ...
                        <div class="mobile-menu">
                            <nav id="mobile-menu-active">
                                <ul class="menu-overflow">
                                    ...
                                    <li><a href="pixel/contact.html"> Contact us</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
