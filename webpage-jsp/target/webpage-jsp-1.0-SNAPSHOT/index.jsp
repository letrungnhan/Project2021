    ...
    <div class="slider-area">
        <div class="slider-active owl-carousel">
            <div class="single-slider slider-1"
                 style="background-image: url(<%=request.getContextPath()%>/assets/img/slider/main-banner.png)">
                <div class="container">
                    <div class="slider-content slider-animated-1">
                        <div class="slider-img text-center">
                            <img class="animated" src="<%=request.getContextPath()%>/assets/img/slider/index-banner1.png"
                                 alt="slider images">
                        </div>
            ...
            <div class="single-slider slider-1"
                ...
                <div class="container">
                    <div class="slider-content slider-animated-1">
                        <div class="slider-img text-center">
                            <img class="animated"
                                 src="<%=request.getContextPath()%>/assets/img/slider/index-banner2.png"
                                 alt="slider images">
                        </div>
                        <div class="slider-text-img">
                            <h6 class="animated">HÃY ĐẶT MẶT HÀNG CỦA BẠN VỚI GIÁ RẺ</h6>
            ...
            <div class="single-slider slider-1"
                ...
                <div class="container">
                    <div class="slider-content slider-animated-1">
                        <div class="slider-img text-center">
                            <img class="animated"
                                 src="<%=request.getContextPath()%>/assets/img/slider/index-banner-4.png"
                                 alt="slider images">
                        </div>
                        <div class="slider-text-img">
                            <h6 class="animated">HÃY ĐẶT MẶT HÀNG CỦA BẠN VỚI GIÁ Rẻ</h6>
                ...
                <div class="single-latest-product slider-animated-2">
                    <div class="row">
                        <div class="col-lg-7 col-col-12 col-12">
                            <div class="latest-product-img">
                                <img class="animated" src="<%=request.getContextPath()%>/assets/img/banner/banner-dell-laptop.png"
                                     alt="image">
                            </div>
                        </div>
