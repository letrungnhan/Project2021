...
<div class="wrapper">
    ...
    <div class="breadcrumb-area pt-255 pb-170" style="background-image: url(assets/img/banner/newsletter-bg.png)">
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <a href="#"><img src="assets/img/cart/logitech-white-cart.png" alt=""></a>
                                </td>
                                <td class="product-name">
                                    <a href="#">Chuột Logitech G102 LightSync White</a>
                                </td>
                                <td class="product-price"><span class="amount">400.000₫</span></td>
                                <td class="product-quantity">
                                    <div class="quantity-range">
                                        <input class="input-text qty text" type="number" step="1" min="0" value="1"
                                               title="Qty" size="4">
                                    </div>
                                </td>
                                <td class="product-subtotal">400.000₫</td>
                                <td class="product-cart-icon product-subtotal"><a href="#"><i class="ti-trash"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="product-thumbnail">
                                    <a href="#"><img src="assets/img/cart/logitech-g102-black.png" alt=""></a>
                                </td>
                                <td class="product-name">
                                    <a href="#">
                                        Chuột Logitech G102 LightSync Black</a>
                                </td>
                                <td class="product-price"><span class="amount">400.000₫</span></td>
                                <td class="product-quantity">
                                    <div class="quantity-range">
                                ...
                                <td class="product-subtotal">400.000₫
                                </td>
                                <td class="product-cart-icon product-subtotal"><a href="#"><i class="ti-trash"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="product-thumbnail">
                                    <a href="#"><img src="assets/img/cart/Edra-ek348.png" alt=""></a>
                                </td>
                                <td class="product-name">
                                    <a href="#">
                                        Bàn phím cơ E-DRA EK384 Red Switch</a>
                                </td>
                                <td class="product-price"><span class="amount">790.000₫
</span></td>
                                <td class="product-quantity">
                                    <div class="quantity-range">
                                        <input class="input-text qty text" type="number" step="1" min="0" value="1"
                                ...
                                <td class="product-subtotal">790.000₫
                                </td>
                                <td class="product-cart-icon product-subtotal"><a href="#"><i class="ti-trash"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="product-thumbnail">
                                    <a href="#"><img
                                            src="assets/img/cart/Gaming%20DareU%20EK87-%20Black%20Multi-LED%20Brown%20Switch.png"
                                            alt=""></a>
                                </td>
                                <td class="product-name">
                                    <a href="#">
                                        Bàn phím Gaming DareU EK87- Black Multi-LED Brown Switch</a>
                                </td>
                                <td class="product-price"><span class="amount">499.000₫
</span></td>
                                <td class="product-quantity">
                                    <div class="quantity-range">
                                        <input class="input-text qty text" type="number" step="1" min="0" value="1"
                                ...
                                <td class="product-subtotal">499.000₫
                                </td>
                                <td class="product-cart-icon product-subtotal"><a href="#"><i class="ti-trash"></i></a>
                                </td>
                            </tr>
