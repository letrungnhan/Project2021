...
public class User implements Serializable {
    ...
    public User(String username, String password, String roleId, String email, String address, int phoneNumber) {
        this.username = username;
        this.password = password;
        this.roleId = roleId;
        this.email = email;
    ...
    public User(String id, String username, String password, String roleId, String email, String address, int phoneNumber) {
        this.id = id;
        this.username = username;
        this.password = password;
        this.roleId = roleId;
